...
let $test := array{map{"data":$bnf,"label":'EXP1 bnf',"x":0,"color":'green'},map{"data":$inha,"label":'EXP1 inha',"x":20,"color":'blue'},map{"data":$all,"label":'EXP1 inha+bnf',"x":40,"color":'red'},map{"data":$bnfNUM,"label":'EXP2 bnf',"x":60,"color":'magenta'}}
