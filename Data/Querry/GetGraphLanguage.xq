...
let $bnf := db:open("publication-internship")//mxc:record//mxc:datafield[@tag='101'] 
let $inha := db:open("publication-internship")//record/controlfield[@tag='006'][text()='751025206']/parent::record//datafield[@tag='101']
let $all := ($bnf,$inha)
