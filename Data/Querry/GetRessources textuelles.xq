...
import module namespace tools= 'http://basex.org/modules/tools' at 'CustomModule/tools.xqm';
import module namespace moremap= 'http://basex.org/modules/moremap' at 'CustomModule/MoreMap.xqm';
...
let $bnf := db:open("Database")/bnf//record//datafield[@tag='105'] 
let $inha := db:open("Database")/inha//record//datafield[@tag='105']
let $all := ($bnf,$inha)
...
return graph:killd([$databnf,$datainha,$all],100,25,1000,500)
